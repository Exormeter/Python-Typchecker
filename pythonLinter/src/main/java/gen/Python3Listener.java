...
public interface Python3Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link Python3Parser#makeshifttype}.
	 * @param ctx the parse tree
	 */
	void enterMakeshifttype(Python3Parser.MakeshifttypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#makeshifttype}.
	 * @param ctx the parse tree
	 */
	void exitMakeshifttype(Python3Parser.MakeshifttypeContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#identifier}.
	 * @param ctx the parse tree
	 */
	void enterIdentifier(Python3Parser.IdentifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#identifier}.
	 * @param ctx the parse tree
	 */
	void exitIdentifier(Python3Parser.IdentifierContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Python3Parser#none}.
	 * @param ctx the parse tree
	 */
	void enterNone(Python3Parser.NoneContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#none}.
	 * @param ctx the parse tree
	 */
	void exitNone(Python3Parser.NoneContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#bool}.
	 * @param ctx the parse tree
	 */
	void enterBool(Python3Parser.BoolContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#bool}.
	 * @param ctx the parse tree
	 */
	void exitBool(Python3Parser.BoolContext ctx);
	/**
