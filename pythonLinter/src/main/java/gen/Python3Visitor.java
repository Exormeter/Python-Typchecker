...
public interface Python3Visitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link Python3Parser#makeshifttype}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMakeshifttype(Python3Parser.MakeshifttypeContext ctx);
	/**
	 * Visit a parse tree produced by {@link Python3Parser#identifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIdentifier(Python3Parser.IdentifierContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Python3Parser#none}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNone(Python3Parser.NoneContext ctx);
	/**
	 * Visit a parse tree produced by {@link Python3Parser#bool}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
